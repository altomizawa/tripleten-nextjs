    ...
    <>
      {slide && <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black/90 z-10">
        <div className="relative allpopups">
            ...
            <div className={`mx-8 md:mx-24 relative ${loading ? 'opacity-0' : ''}`}>
              ...
              <Image onLoad={() => setLoading(false)} width={1920} height={1080} className='object-cover mx-auto w-full h-auto max-h-[80vh]' src={slide.imageUrl} alt={slide.description} />
